  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/products/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="desproduct">Descrição Completa</label>
              <input type="text" class="form-control" id="desdescricaoProduto" name="desdescricaoProduto" placeholder="Digite a descrição do produto" value="<?php echo htmlspecialchars( $product["desdescricaoProduto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
            <div class="form-group">
