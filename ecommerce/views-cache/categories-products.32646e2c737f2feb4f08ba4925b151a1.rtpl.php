...
<section class="content-header">
  <h1>
    Produtos da Categoria <strong><?php echo htmlspecialchars( $category["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-success">
                <div class="box-header with-border">
                <h3 class="box-title">Produtos na Categoria <strong><?php echo htmlspecialchars( $category["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
