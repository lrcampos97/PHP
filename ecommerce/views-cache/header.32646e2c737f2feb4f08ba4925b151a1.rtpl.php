...
<head>
  ...
  <title>E-commerce Store | Admin</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin/orders" class="logo">
      ...
      <span class="logo-mini"><b>E-commerce</b> Store</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>E-commerce</b> Store</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/products"><i class="fa fa-barcode"></i> <span>Produtos</span></a></li>
